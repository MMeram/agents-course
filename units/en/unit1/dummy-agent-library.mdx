...
You can follow the process [in this notebook](https://colab.research.google.com/github/MMeram/agents-course/blob/main/units/en/unit1/dummy_agent_library.ipynb) and **run the code yourself**.
